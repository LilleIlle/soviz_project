...
# we spend a fair amount of time seeking out a data set of high quality and not just one that seemed interesting on the surface.
# Eventually, we found the Chicago data sets that seemed promising. This was indeed the case, as we found the data sets
# to be rich and well-groomed with few missing data points and many interesting attributes—more than we had time to cover in
# this project. This in turn resulted in a smooth data cleaning and pre-processing phase that quickly launched us into
# doing actual visualization work. Hence, taking the time to research a promising data set was likely a good use of time in the initial phase of this project.
# For the visualizations, we have had a focus on temporal plots and animations which have shown interesting patterns of traffic
# in different regions of the city throughout the day, month and the grander scheme of a whole year. Furthermore, the focus on
# primary contributory causes for traffic accidents enabled us to see which causes are most common on different times of the day.
#
# ### What is still missing? What could be improved? Why?
#
# At the outset of this project one of our main goals was to make a quantified assessment of how dangerous
...
#
# For future work, it could be interesting to assess the amount of traffic more precisely, to be able to precisely visualize and assess which
# parts of the city has the highest probability of a crash relatively to the amount of traffic. This would ultimately require a different means of
