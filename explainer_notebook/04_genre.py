...
# # 4. Genre
#
# The website is a single frame _Magazine Style_, where each visualization is embedded in text describing as well as discussing the given visualization.
...
#
# In terms of Visual Narrative tools (Figure 7 in [Segal and Heer]), highlighting (e.g. feature distinction, motion and zooming) is employed to help direct the viewer’s attention to particular elements of the different scenes.
